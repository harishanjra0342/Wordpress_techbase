                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl font-semibold text-black dark:text-white">Haris Hanjra</h2>

                                        <p class="mt-4 text-sm/relaxed">
                                            Hello Haris Hanjra Is Here
                                        </p>
                                    </div>
                                </div>
                        ...
                        <a href="https://laravel-news.com"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Haris Hanjra News</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Haris Hanjra News is a community driven portal and newsletter aggregating all of the
